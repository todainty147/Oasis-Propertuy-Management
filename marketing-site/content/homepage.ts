    ...
    items: [
      {
        ...
        imageSrc: "/screenshots/maintenance-inbox.png",
        imageAlt: "OASIS Maintenance Inbox showing incoming requests and linked workflow context.",
      },
      {
        label: "T:05",
      ...
      {
        label: "T:15",
        title: "Contractor updates progress and the trail is already there",
        body: "The work gets resolved, the audit trail is updated, and nobody needs a round of phone calls just to know what happened.",
        href: "/features/tenant-management",
        points: ["approve", "track", "resolve"],
        imageSrc: "/screenshots/security-audit.png",
        imageAlt: "OASIS Security Audit and workflow accountability surface showing operational records.",
      },
    ],
  },
  finalCta: {
