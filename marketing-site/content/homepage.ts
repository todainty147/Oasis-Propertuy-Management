...
export const homepageContentByLocale: Record<Locale, HomePageContent> = {
  ...
  pl: {
    seo: {
      title: "Tenaqo | Oprogramowanie do zarządzania najmem dla właścicieli",
      description:
        "Tenaqo pomaga właścicielom zarządzać czynszami, konserwacją, najemcami, dokumentami, gotowością do zgodności oraz kolejkami działań wspomaganymi przez AI z jednego pulpitu operacyjnego.",
      canonicalPath: "/pl",
    },
    hero: {
      eyebrow: "Zautomatyzowane oprogramowanie do zarządzania nieruchomościami dla właścicieli",
      title: "Mniej stresu dla właściciela. Większa kontrola nad każdym wynajmem.",
      body:
        "Tenaqo łączy czynsze, naprawy, dokumenty, wykonawców, gotowość na compliance oraz kolejki zadań wspierane przez AI w jednej warstwie operacyjnej — dzięki czemu właściciele wiedzą, co wymaga podjęcia kroków w następnej kolejności.",
      emphasis:
    ...
    problemSection: {
      eyebrow: "Dlaczego właściciele decydują się na zmianę",
      title: "Problemem nie są dane. Problemem są przekazania pracy.",
      body:
        "Praca zaczyna się sypać, gdy upominanie się o czynsz, decyzje o naprawach, dokumenty i koordynacja wykonawców znajdują się w zupełnie różnych miejscach.",
      items: [
        {
          title: "Zadania giną w skrzynkach odbiorczych",
          body: "To, co wymaga uwagi, zostaje pogrzebane w mailach, czatach, arkuszach kalkulacyjnych i ludzkiej pamięci, zanim ktokolwiek zdąży popchnąć sprawę do przodu.",
        },
        {
          title: "Naprawy tracą tempo",
          body: "Zgłoszenie od najemcy zamienia się w notatkę dla wykonawcy, następnie w opóźnione zlecenie, a na końcu w naprawę, za którą nikt nie ponosi pełnej odpowiedzialności.",
        },
        {
          title: "Dokumenty odrywają się od rzeczywistej pracy",
          body: "Trudniej zaufać umowom, wymaganym dowodom, elementom compliance i podpisom, gdy znajdują się one poza głównym obiegiem pracy.",
        },
        {
    ...
    solutionSection: {
      title: "Jedna platforma do pracy po otrzymaniu wiadomości",
      body:
        "Tenaqo pomaga właścicielom prowadzić operacje wynajmu mieszkań, a nie tylko przechowywać dane. Utrzymuje kolejki uwagi, wykonanie prac, aktualizacje najemców i historię audytu w jednym miejscu.",
      items: [
        {
          title: "Zobacz, co wymaga działania",
          body: "Zacznij od pilnych kolejek, zaległych spraw i zablokowanej pracy zamiast odtwarzać dzień z osobnych narzędzi.",
        },
        {
          title: "Zachowaj kontrolę",
          body: "Utrzymuj widoczność przepływu pracy najemcy, właściciela i wykonawcy od pierwszego zgłoszenia do ukończonego zlecenia.",
        },
        {
          title: "Używaj AI tam, gdzie pomaga",
          body: "Briefingi Command Center, triage konserwacji, rekomendacje wykonawców i objaśnienia nieruchomości przyspieszają następną decyzję, nie odbierając jej tobie.",
        },
        {
          title: "Utrzymuj historię w całości",
          body: "Dokumenty, widoczność płatności, przegląd zgodności, powiadomienia i audyt bezpieczeństwa pozostają powiązane z tą samą historią operacyjną.",
        },
      ],
    },
    productPreview: {
      title: "Codzienne kontrole właściciela, w końcu w jednym miejscu",
      body:
        "Czynsze, naprawy, dokumenty i follow-up — każdy widok szybko odpowiada na praktyczne pytanie: co wymaga działania, kto za to odpowiada, gdzie rośnie ryzyko i jaki powinien być następny krok.",
      items: [
        {
          label: "Czynsze i Finanse",
          title: "Poznaj kwotę, zanim zobaczą ją finanse",
          body: "Przeglądaj zasady czynszu, oczekiwane opłaty, zaległości i salda, zanim cokolwiek trafi do ksiąg.",
          points: ["podgląd przed zaksięgowaniem", "historia planu czynszowego", "widoczność zaległości"],
          imageSrc: "/screenshots/payment-setup.png",
          imageAlt: "Widok finansów Tenaqo pokazujący konfigurację płatności i salda czynszu.",
        },
        {
          label: "Command Center",
          title: "Pilne sygnały, omówione i gotowe do działania",
          body: "Command Center gromadzi zaległe sprawy, presję na follow-up oraz briefing operacyjny AI, dzięki czemu następny krok jest oczywisty.",
          points: ["briefing dla całego portfela", "kolejki uwagi", "kolejne cele przeglądu"],
          imageSrc: "/screenshots/command-center.png",
          imageAlt: "Command Center Tenaqo z briefingiem operacyjnym AI i kolejkami zadań dla całego konta.",
        },
        {
          label: "Naprawy",
          title: "Od zgłoszenia do rozwiązania — w jednym miejscu",
          body: "Zgłoszenia, triage, zlecenia robocze, koordynacja wykonawców i aktualizacje statusów pozostają w jednym przepływie operacyjnym.",
          points: ["triage AI", "kontrola zleceń roboczych", "koordynacja wykonawców"],
          imageSrc: "/screenshots/maintenance-inbox.png",
          imageAlt: "Skrzynka Napraw Tenaqo pokazująca triage AI, kolumny zgłoszeń i powiązane zlecenia robocze.",
        },
        {
          label: "Kondycja Nieruchomości",
          title: "Zobacz presję na nieruchomość, zanim problem się rozprzestrzeni",
          body: "Scoring kondycji zamienia zaległości, obciążenie naprawami, presję pustostanów i luki compliance w widok gotowy do działania — z objaśnieniem AI.",
          points: ["scoring ryzyka", "objaśnienia AI", "wcześniejsza interwencja"],
          imageSrc: "/screenshots/portfolio-health.png",
          imageAlt: "Strona Kondycji Portfela Tenaqo pokazująca scoring, ryzyko nieruchomości i kartę objaśnienia AI.",
        },
      ],
    },
    healthSection: {
      eyebrow: "Kondycja nieruchomości",
      title: "Dowiedz się, która nieruchomość wymaga interwencji, zanim problemy staną się kosztowne",
      body:
        "Tenaqo łączy obciążenie naprawami, zaległości, opóźnienia wykonawców, luki w compliance i presję na wynajem w jeden wskaźnik kondycji, dzięki czemu właściciele mogą interweniować wcześniej.",
      items: [
        {
          title: "Zobacz, które adresy zaczynają sprawiać problemy",
          body: "Sprawdzaj najsłabsze nieruchomości w pierwszej kolejności, zamiast polegać na intuicji i rozproszonych arkuszach kalkulacyjnych.",
        },
        {
          title: "Zrozum, dlaczego wynik uległ zmianie",
          body: "Moduł objaśniający AI pokazuje, czy ryzyko wynika z napraw, compliance, płatności, czy presji pustostanów.",
        },
        {
          title: "Powiąż sygnał z odpowiednim procesem",
          body: "Ten sam widok odsyła z powrotem do zgłoszenia, zlecenia lub problemu z dokumentami, które wpływają na dany wynik.",
        },
        {
          title: "Chroń cały swój portfel",
          body: "Presja na poziomie pojedynczej nieruchomości zamienia się w przejrzystość całego portfela, a nie w niespodziankę po tym, jak szkody już się rozprzestrzenią.",
        },
      ],
      imageSrc: "/screenshots/portfolio-health.png",
      imageAlt:
        "Panel Kondycji Portfela Tenaqo pokazujący ryzyko nieruchomości, strukturę najmu i gotowe do działania objaśnienia.",
      imageAlign: "left",
    },
    tenantPortalSection: {
      eyebrow: "Przepływ pracy najemcy i wykonawcy",
      title: "Informuj najemców i koordynuj wykonawców bez utraty kontroli",
      body:
        "Tenaqo daje najemcom jasną ścieżkę samoobsługi, utrzymując jednocześnie przepływ pracy właściciela i wykonawcy ściśle połączony w tle.",
      items: [
        {
          title: "Najemcy widzą to, co ważne",
          body: "Aktualizacje konserwacji, żądane dokumenty, widoczność płatności i kroki umowy pozostają widoczne w jednym bezpiecznym portalu.",
        },
        {
          title: "Wykonawcy poruszają się określoną ścieżką",
          body: "Wyceny, aktualizacje, status zleceń i potwierdzenia pozostają powiązane ze zgłoszeniem, zamiast dryfować do pobocznych kanałów.",
        },
        {
          title: "Właściciele zachowują kontrolę",
          body: "Każda aktualizacja trafia do tego samego śladu audytowego, ścieżki akceptacji i kontekstu nieruchomości.",
        },
      ],
      imageSrc: "/screenshots/tenant-documents.png",
      imageAlt: "Strona dokumentów portalu najemcy Tenaqo pokazująca prośby o dokumenty, przesyłanie plików i przegląd umowy.",
    ...
    workflowSection: {
      ...
      body:
        "Tenaqo jest zbudowany wokół realnej ścieżki od zgłoszenia najemcy, przez decyzję właściciela, po wykonanie przez wykonawcę i ukończony follow-up.",
      itemCtaLabel: "Poznaj ten workflow",
      items: [
        {
          label: "Krok 1",
          title: "Najemca zgłasza problem z dołączonym właściwym kontekstem",
          body: "Zgłoszenie trafia z kontekstem nieruchomości, czasem i czytelnym zapisem, zamiast stawać się kolejną wiadomością do późniejszego odtworzenia.",
          href: "/features/maintenance-management",
          points: ["jasne przyjmowanie zgłoszeń", "kontekst nieruchomości", "śledzone zgłoszenie"],
          imageSrc: "/screenshots/property-requests.png",
          imageAlt: "Widok zgłoszeń Tenaqo pokazujący problemy zgłoszone przez najemców i powiązany follow-up operacyjny.",
        },
        {
          label: "Krok 2",
          title: "Właściciel przypisuje wykonanie i otwiera ścieżkę dla wykonawcy",
          body: "Kolejny właściciel sprawy jest oczywisty, zlecenie rozpoczyna się w tym samym systemie, a wszyscy widzą ten sam kontekst na żywo.",
          href: "/features/maintenance-management",
    ...
    securitySection: {
      eyebrow: "Bezpieczeństwo i ślad audytowy",
      title: "Działaj szybko, nie tracąc odpowiedzialności",
      body:
        "Uprawnienia, ekrany przeglądu i ślady bezpieczeństwa pomagają właścicielom zrozumieć, kto co zmienił, co zostało zatwierdzone i co wymaga uwagi w następnej kolejności.",
      items: [
        {
          title: "Dostęp oparty na rolach",
          body: "Właściciele, personel, najemcy i wykonawcy pozostają w odpowiednim zakresie działań, zamiast widzieć wszystko.",
        },
        {
          title: "Prawdziwy ślad audytowy",
          body: "Działania na dokumentach, aktualizacje zleceń, akceptacje i wrażliwe zmiany są dostępne, gdy potrzebujesz je sprawdzić.",
        },
        {
          title: "Odpowiedzialność operacyjna",
          body: "Kiedy coś się zmienia, wiesz gdzie to się stało, kto tego dokonał i na co to wpłynęło.",
        },
        {
          title: "Przegląd bezpieczeństwa dopasowany do operacji",
          body: "Strony bezpieczeństwa i audytu są stworzone dla prawdziwych operatorów, a nie tylko dla pozorów zgodności.",
        },
      ],
      imageSrc: "/screenshots/security-audit.png",
      imageAlt: "Strona Audytu Bezpieczeństwa Tenaqo pokazująca ustawienia polityk i ślady przeglądu w ramach konta.",
    },
    finalCta: {
