...
export const complianceContent = {
  ...
  problemSection: {
    ...
    body:
      "Each item is small on its own. Together they build into the kind of risk that shows up at renewal time, at tax time, or when a tenant stops paying. Tenaqo brings these signals into one place and turns them into clear actions.",
    items: [
      {
  ...
  rentShieldSection: {
    ...
    body:
      "Rent problems rarely appear out of nowhere. They build through patterns — late payments, high maintenance activity, tenancy pressure. Rent Shield gives each property a risk view based on operational data already held in Tenaqo.",
    items: [
      {
        title: "Risk built from what Tenaqo already knows",
    ...
    imageAlt:
      "Tenaqo Rent Shield showing per-property risk bands and portfolio-wide rent exposure scoring.",
    imageAlign: "left" as const,
    disclaimer:
      "Rent Shield is an operational risk estimate based on available Tenaqo data. It is not financial advice, credit scoring, insurance advice, or a guarantee of rent payment.",
  },
  taxSection: {
    ...
    imageAlt:
      "Tenaqo Tax Readiness Dashboard showing deadline status, completed obligations, and export controls.",
    imageAlign: "right" as const,
    disclaimer:
      "Tenaqo helps organise tax-related records and exports. It does not provide tax, accounting, or legal advice. Always verify records with a qualified professional before filing.",
  },
  connectedSection: {
    eyebrow: "Compliance that connects to your operations",
    title: "Part of daily operations, not a separate checklist",
    body:
      "The Compliance Suite is not hidden away from the rest of the system. It connects into the way Tenaqo already works, so compliance becomes something your team sees and acts on every day.",
    items: [
      {
  ...
  finalCta: {
    ...
    body:
      "See how Tenaqo turns compliance into a managed, auditable process so nothing slips through the cracks as the portfolio grows.",
    primaryCta: { label: "See Tenaqo in action", href: siteConfig.appUrl },
