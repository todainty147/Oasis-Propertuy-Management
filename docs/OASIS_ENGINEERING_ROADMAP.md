...
| Sandbox / demo onboarding | The first-value experience is real, and demo lifecycle operations now have a soft-expiry policy, safe reset/reseed workflow, and first-value evidence checklist. Remaining maturity is tooling automation and richer fixtures. | [ACCOUNT_SANDBOX_PROFILES.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/ACCOUNT_SANDBOX_PROFILES.md), [sandbox-demo-onboarding-operations.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/runbooks/sandbox-demo-onboarding-operations.md), [sandbox-demo-evidence-template.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/templates/sandbox-demo-evidence-template.md), [account_sandbox_demo_seed.sql](/mnt/c/Users/Home/oasisrentalmanagementapp/supabase/account_sandbox_demo_seed.sql), [LandlordSignup.jsx](/mnt/c/Users/Home/oasisrentalmanagementapp/src/pages/LandlordSignup.jsx), [LandlordOnboardingPage.jsx](/mnt/c/Users/Home/oasisrentalmanagementapp/src/pages/LandlordOnboardingPage.jsx) | Build future support tooling for demo list, extend-demo, archive/disable, export-before-reset, and richer fixture versions. |
| Support operations | Support runbooks and root telemetry exist, and the support front door now defines ticket fields, severity, routing, escalation, and customer response templates. Recurring access-review evidence still needs to mature. | [docs/runbooks](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/runbooks), [support-triage-workflow.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/runbooks/support-triage-workflow.md), [RootTelemetryPage.jsx](/mnt/c/Users/Home/oasisrentalmanagementapp/src/pages/RootTelemetryPage.jsx), [security-alert-response.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/runbooks/security-alert-response.md) | Add quarterly privileged access review evidence and keep support ticket templates tied to real incidents. |
| Production monitoring execution | Golden signals and alert thresholds are documented, and the repo now defines a daily/weekly operating rhythm with named owner roles, action thresholds, and evidence capture. The remaining maturity step is proving the rhythm with real production review records. | [OPERATIONAL_GOLDEN_SIGNALS.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/OPERATIONAL_GOLDEN_SIGNALS.md), [production-monitoring-rhythm.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/runbooks/production-monitoring-rhythm.md), [monitoring-evidence-template.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/templates/monitoring-evidence-template.md), [security-alert-response.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/runbooks/security-alert-response.md) | Start recording daily checks and weekly trend reviews; link action triggers to support, security, or release tickets. |

### Next

| Area | Why it belongs next | Repo evidence | Recommended outcome |
| --- | --- | --- | --- |
| Product analytics / funnel measurement | The repo has security and operational telemetry, a vendor-neutral analytics specification, and a centralized no-op-safe analytics wrapper with redaction tests. Production capture is still disabled until the Supabase/event-sink choice is implemented. | [PRODUCT_ANALYTICS_MEASUREMENT_SPEC.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/PRODUCT_ANALYTICS_MEASUREMENT_SPEC.md), [productAnalyticsService.js](/mnt/c/Users/Home/oasisrentalmanagementapp/src/services/productAnalyticsService.js), [productAnalyticsService.test.js](/mnt/c/Users/Home/oasisrentalmanagementapp/tests/security/productAnalyticsService.test.js), [product-analytics-event-review-template.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/templates/product-analytics-event-review-template.md) | Add the Supabase-backed event sink, keep analytics disabled by default until reviewed, then capture the first activation events. |
