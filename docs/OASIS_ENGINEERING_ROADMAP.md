...
| --- | --- | --- | --- |
| Product analytics / funnel measurement | The repo has security and operational telemetry, and now has a vendor-neutral product analytics specification for activation, demo first value, invite acceptance, operator-surface adoption, and billing intent. Implementation is still intentionally deferred until the sink/privacy choice is made. | [PRODUCT_ANALYTICS_MEASUREMENT_SPEC.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/PRODUCT_ANALYTICS_MEASUREMENT_SPEC.md), [product-analytics-event-review-template.md](/mnt/c/Users/Home/oasisrentalmanagementapp/docs/templates/product-analytics-event-review-template.md), signup/onboarding/billing/invite routes in [App.jsx](/mnt/c/Users/Home/oasisrentalmanagementapp/src/App.jsx) | Choose analytics sink, implement a centralized analytics wrapper, add redaction tests, and capture the first activation events. |
