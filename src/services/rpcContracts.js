...
export function parseSelfServeLandlordAccountResult(row) {
  ...
  return {
    ...
    account_name: toStringOr(value.account_name),
    role: toStringOr(value.role).trim().toLowerCase(),
    subscription_plan: toNullableString(value.subscription_plan),
    subscription_status: toNullableString(value.subscription_status),
    billing_locked_at: toNullableString(value.billing_locked_at),
    trial_ends_at: toNullableString(value.trial_ends_at),
    trial_source: toNullableString(value.trial_source),
...
export function parseDocumentRow(row) {
  ...
  return {
    ...
    storage_path_quarantine: toNullableString(value.storage_path_quarantine),
    storage_path_active: toNullableString(value.storage_path_active),
    upload_status: toStringOr(value.upload_status).trim().toLowerCase(),
    scan_status: toStringOr(value.scan_status || "legacy_unscanned").trim().toLowerCase(),
    scanned_at: toNullableString(value.scanned_at),
    scanned_by_system: toBooleanOr(value.scanned_by_system),
    scan_provider: toNullableString(value.scan_provider),
    scan_reference_id: toNullableString(value.scan_reference_id),
    scan_error: toNullableString(value.scan_error),
    quarantine_reason: toNullableString(value.quarantine_reason),
