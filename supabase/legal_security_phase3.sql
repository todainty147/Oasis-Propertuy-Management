...
join (
  values
    ('boiler_heating','immediate_danger','Is there a smell of gas, active leak, burning smell, or immediate danger?','yes_no','[]','Do not attempt repairs you are not qualified to perform.',10),
    ...
    ('no_hot_water','immediate_danger','Is there a smell of gas, active leak, burning smell, or immediate danger?','yes_no','[]','If there is immediate danger, stop and contact the relevant emergency provider.',10),
    ...
    ('damp_mould','active_leak','Is there an active leak, flooding, or water entering the property now?','yes_no','[]','Active leaks should be reported urgently.',20),
    ('damp_mould','photos','Can you upload photos of the affected area?','photo','[]',null,30),
    ('electrical_issue','immediate_danger','Is there sparking, smoke, burning smell, exposed wiring, or loss of power creating immediate risk?','yes_no','[]','Do not touch exposed wiring or unsafe fittings.',10),
    ...
    ('blocked_drain','overflowing','Is water overflowing or backing up inside the property?','yes_no','[]','Overflowing water may need urgent review.',10),
    ...
    ('leak','active_leak','Is water actively leaking now?','yes_no','[]','If flooding is severe, contact emergency support.',10),
    ...
    ('lost_keys_security','security_risk','Is there an immediate security risk or suspected break-in?','yes_no','[]','If there is immediate risk, contact emergency services.',10),
