...
revoke all on function public.command_center_items(uuid, integer) from public, anon;
...
revoke all on function public.attention_center_items(uuid, integer) from public, anon;
...
grant execute on function public.get_operating_calendar(uuid, date, date, uuid, text, text, text)
  to authenticated;
revoke all on function public.get_operating_calendar(uuid, date, date, uuid, text, text, text) from public, anon;
