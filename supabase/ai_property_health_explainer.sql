-- =========================================================
-- AI property health explainer
-- Purpose: extend the AI insight foundation so OASIS can cache
-- property-scoped health explanations without changing the earlier
-- attention briefing rollout contract.
-- =========================================================
...
alter table public.ai_insights
  ...
  check (insight_type in ('attention_briefing', 'property_health_explainer'));
