-- =========================================================
-- AI maintenance triage suggestions
-- Purpose: extend the AI insight foundation so OASIS can cache
-- request-scoped maintenance triage suggestions without changing
-- the earlier account/property AI rollout contract.
-- =========================================================
...
alter table public.ai_insights
  ...
  check (insight_type in ('attention_briefing', 'property_health_explainer', 'maintenance_triage_suggestion'));
